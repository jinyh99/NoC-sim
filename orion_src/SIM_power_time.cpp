...
//double wirelength;	/* poly wire length going to gate in lambda */
{
  ...
  return gateCap;
#endif
  return(width*Leff*PARM(Cgate)+wirelength*Cpolywire*Leff * orion::SCALE_T);
...
double SIM_power_decoder_delay(int C, int B, int A, int Ndwl, int Ndbl, int Nspd, int Ntwl, int Ntbl, int Ntspd, 
...
//double *Tdecdrive,*Tdecoder1,*Tdecoder2,*outrisetime;
{
	...
	double z = 0.0;
        ...
        *Tdecdrive = SIM_power_horowitz(nextinputtime,tf,PARM(VTHINV100x60),PARM(VTHNAND60x90),
        ...
        default: cout << "error:numstack=" << numstack << endl; break;
	}
...
double SIM_power_mux_driver_delay(int C, int B, int A, int Ndbl, int Nspd, int Ndwl, int Ntbl, int Ntspd,
